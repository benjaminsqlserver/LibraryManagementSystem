...
{
    public partial class EditBorrowerDetail
    {
        [Inject]
        ...
        {
            borrowerDetail = await MyLibraryDBService.GetBorrowerDetailById(id:ID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await MyLibraryDBService.UpdateBorrowerDetail(id:ID, borrowerDetail);
