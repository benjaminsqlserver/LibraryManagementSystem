...
{
    public partial class EditBindingDetail
    {
        [Inject]
        ...
        {
            bindingDetail = await MyLibraryDBService.GetBindingDetailByBindingId(bindingId:BindingID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await MyLibraryDBService.UpdateBindingDetail(bindingId:BindingID, bindingDetail);
