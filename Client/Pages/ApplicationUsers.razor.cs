...
namespace LibraryManagementSystem.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<LibraryManagementSystem.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<LibraryManagementSystem.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(LibraryManagementSystem.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(LibraryManagementSystem.Server.Models.ApplicationUser user)
        {
            try
            {
