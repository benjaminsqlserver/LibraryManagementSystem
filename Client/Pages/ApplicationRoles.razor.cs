...
namespace LibraryManagementSystem.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<LibraryManagementSystem.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(LibraryManagementSystem.Server.Models.ApplicationRole role)
        {
            try
            {
