...
{
    public partial class EditLibraryClient
    {
        [Inject]
        ...
        {
            libraryClient = await MyLibraryDBService.GetLibraryClientByLibraryClientId(libraryClientId:LibraryClientID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await MyLibraryDBService.UpdateLibraryClient(libraryClientId:LibraryClientID, libraryClient);
