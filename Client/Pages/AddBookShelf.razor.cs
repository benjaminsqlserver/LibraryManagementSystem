...
{
    public partial class AddBookShelf
    {
        [Inject]
        ...
        {
            bookShelf = new LibraryManagementSystem.Server.Models.MyLibraryDB.BookShelf();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await MyLibraryDBService.CreateBookShelf(bookShelf);
